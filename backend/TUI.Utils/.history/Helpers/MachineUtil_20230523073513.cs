...
public static class MachineUtil
{
    ...
    /// </summary>
    /// <returns></returns>
    public static async Task<MachineInfo> GetMachineBaseInfo()
    {
        ...
        var machineInfo = new MachineInfo
        {
            ...
            LanIp = GetLanIp(),//networkInfo.AddressIpv4.ToString(), // 局域网IP
            ...
            RunTime = System.Diagnostics.Process.GetCurrentProcess().StartTime.ToString("yyyy-MM-dd HH:mm") //运行时间
        };
        var ts = DateTime.Now - System.Diagnostics.Process.GetCurrentProcess().StartTime;
        machineInfo.RunTime = $"{ts.Days}天{ts.Hours}时{ts.Minutes}分{ts.Seconds}秒";
        return machineInfo;
    }
...
public class MachineInfo
{
    ...
    /// <summary>
    /// 上下行流量统计
    /// "上行" + Math.Round(networkInfo.SendLength / 1024.0 / 1024 / 1024, 2) + "GB 下行" + Math.Round(networkInfo.ReceivedLength / 1024.0 / 1024 / 1024, 2) + "GB",
    /// </summary>
    public string SendAndReceived { get; set; }

    /// <summary>
    /// networkInfo.AddressIpv4.ToString(), // 局域网IP
    /// </summary>
    ...
    /// <summary>
    /// "上行" + Send / 1024 + "kb/s 下行" + Received / 1024 + "kb/s" // 网络速度
    /// </summary>
