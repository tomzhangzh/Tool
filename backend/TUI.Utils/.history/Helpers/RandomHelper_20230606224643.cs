...
public static class RandomHelper
{
    ...
    {
        var allChar = "0123456789TUIDEFGHIJKLMNOPQRSTUVWXYZTUIdefghijklmnopqrstuvwxyz";
        ...
        else
        {
            switch (randtype)
            {
                case RandType.NumAndStr:
                    allChar = "0123456789TUIDEFGHIJKLMNOPQRSTUVWXYZTUIdefghijklmnopqrstuvwxyz";
                    break;
                ...
                case RandType.Str:
                    allChar = "TUIDEFGHIJKLMNOPQRSTUVWXYZTUIdefghijklmnopqrstuvwxyz";
                    break;
            }
        }
        var randomCode = "";
