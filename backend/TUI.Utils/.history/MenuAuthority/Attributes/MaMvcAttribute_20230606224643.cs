...
public sealed class MaMvcAttribute : Attribute
{
    /// <summary>
    /// 权限控制器
    /// </summary>
    ...
    public MaMvcAttribute(string area = "HtAdmin", string controller = "", string controllerDescription = "")
    {
        Area = area;
    ...
    /// 菜单分组（API,后台）
    /// </summary>
    public MenuAreaType MenuAreaType { get; set; } = MenuAreaType.Mvc;
