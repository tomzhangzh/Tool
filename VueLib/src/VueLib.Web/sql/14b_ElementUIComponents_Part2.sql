...
USING (VALUES (N'ElButton', 4, N'通用', N'按钮', N'🔘',
    N'{"component":"ElButton","options":{"comoptions":{"text":"按钮","type":"primary"}}}',
    N'/ElementComponent/Common/Button', N'ElementUI 按钮', 1, 120, N'elementui',
...
-- ElTag
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'ElTag', 3, N'展示', N'标签', N'🏷️',
    N'{"component":"ElTag","options":{"comoptions":{"text":"标签","type":""}}}',
    N'/ElementComponent/Common/Tag', N'ElementUI 标签', 1, 130, N'elementui',
...
-- ElBadge
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'ElBadge', 3, N'展示', N'徽章', N'🔴',
    N'{"component":"ElBadge","options":{"comoptions":{"value":5}}}',
    N'/ElementComponent/Common/Badge', N'ElementUI 徽章', 1, 131, N'elementui',
...
-- ElAvatar
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'ElAvatar', 3, N'展示', N'头像', N'👤',
    N'{"component":"ElAvatar","options":{"comoptions":{"text":"A","size":"large"}}}',
    N'/ElementComponent/Common/Avatar', N'ElementUI 头像', 1, 132, N'elementui',
...
-- ElProgress
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'ElProgress', 3, N'展示', N'进度条', N'📊',
    N'{"component":"ElProgress","modelname":"","options":{"comoptions":{"percentage":50}}}',
    N'/ElementComponent/Common/Progress', N'ElementUI 进度条', 1, 133, N'elementui',
...
-- ElAlert
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'ElAlert', 3, N'展示', N'警告提示', N'⚠️',
    N'{"component":"ElAlert","options":{"comoptions":{"title":"提示信息","type":"info","showIcon":true}}}',
    N'/ElementComponent/Common/Alert', N'ElementUI 警告提示', 1, 134, N'elementui',
...
-- ElDivider
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'ElDivider', 3, N'展示', N'分割线', N'➖',
    N'{"component":"ElDivider","options":{"comoptions":{"text":""}}}',
    N'/ElementComponent/Common/Divider', N'ElementUI 分割线', 1, 135, N'elementui',
...
-- ElImage
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'ElImage', 3, N'展示', N'图片', N'🖼️',
    N'{"component":"ElImage","options":{"comoptions":{"src":"","fit":"cover"}}}',
    N'/ElementComponent/Common/Image', N'ElementUI 图片', 1, 136, N'elementui',
...
-- ElDivContainer
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'ElDivContainer', 2, N'布局', N'DIV容器', N'📦',
    N'{"component":"ElDivContainer","childrenctrls":[],"options":{"itemoptions":{"style":{"padding":"12px"}}}}',
    N'/ElementComponent/Container/DivContainer', N'ElementUI DIV容器', 1, 140, N'elementui',
...
-- ElCard
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'ElCard', 2, N'布局', N'卡片', N'🗂️',
    N'{"component":"ElCard","childrenctrls":[],"options":{"comoptions":{"title":"卡片标题"}}}',
    N'/ElementComponent/Container/Card', N'ElementUI 卡片容器', 1, 141, N'elementui',
...
-- ElRow
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'ElRow', 2, N'布局', N'行布局', N'↔️',
    N'{"component":"ElRow","childrenctrls":[],"options":{"comoptions":{"gutter":20}}}',
    N'/ElementComponent/Container/Row', N'ElementUI 行布局', 1, 142, N'elementui',
...
-- ElCol
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'ElCol', 2, N'布局', N'列布局', N'↕️',
    N'{"component":"ElCol","childrenctrls":[],"options":{"comoptions":{"span":12}}}',
    N'/ElementComponent/Container/Col', N'ElementUI 列布局', 1, 143, N'elementui',
...
-- ElTabs
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'ElTabs', 2, N'布局', N'标签页', N'📑',
    N'{"component":"ElTabs","childrenctrls":[],"options":{"comoptions":{"type":""}}}',
    N'/ElementComponent/Container/Tabs', N'ElementUI 标签页', 1, 144, N'elementui',
