...
USING (VALUES (N'DynElInput', 1, N'表单', N'输入框', N'📝',
    N'{"component":"DynElInput","modelname":"","options":{"comoptions":{"placeholder":"请输入"},"labeloptions":{"label":""}}}',
    N'/ElementComponent/FormItem/Input', N'ElementUI 文本输入框', 1, 100, N'DynElementui',
...
-- ElInputNumber
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'DynElInputNumber', 1, N'表单', N'数字输入', N'🔢',
    N'{"component":"DynElInputNumber","modelname":"","options":{"comoptions":{"min":0,"max":100,"step":1},"labeloptions":{"label":""}}}',
    N'/ElementComponent/FormItem/InputNumber', N'ElementUI 数字输入框', 1, 101, N'DynElementui',
...
-- ElSelect
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'DynElSelect', 1, N'表单', N'下拉选择', N'📋',
    N'{"component":"DynElSelect","modelname":"","options":{"comoptions":{"placeholder":"请选择","clearable":true},"labeloptions":{"label":""},"optionValues":"选项1,选项2"}}}',
    N'/ElementComponent/FormItem/Select', N'ElementUI 下拉选择', 1, 102, N'DynElementui',
...
-- ElSwitch
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'DynElSwitch', 1, N'表单', N'开关', N'🎚️',
    N'{"component":"DynElSwitch","modelname":"","options":{"comoptions":{},"labeloptions":{"label":""}}}',
    N'/ElementComponent/FormItem/Switch', N'ElementUI 开关', 1, 103, N'DynElementui',
...
-- ElRadio
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'DynElRadio', 1, N'表单', N'单选框组', N'🔘',
    N'{"component":"DynElRadio","modelname":"","options":{"comoptions":{},"labeloptions":{"label":""},"optionValues":"选项1,选项2,选项3"}}}',
    N'/ElementComponent/FormItem/Radio', N'ElementUI 单选框组', 1, 104, N'DynElementui',
...
-- ElCheckbox
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'DynElCheckbox', 1, N'表单', N'多选框组', N'☑️',
    N'{"component":"DynElCheckbox","modelname":"","options":{"comoptions":{},"labeloptions":{"label":""},"optionValues":"选项1,选项2,选项3"}}}',
    N'/ElementComponent/FormItem/Checkbox', N'ElementUI 多选框组', 1, 105, N'DynElementui',
...
-- ElDatePicker
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'DynElDatePicker', 1, N'表单', N'日期选择', N'📅',
    N'{"component":"DynElDatePicker","modelname":"","options":{"comoptions":{"type":"date","placeholder":"选择日期"},"labeloptions":{"label":""}}}',
    N'/ElementComponent/FormItem/DatePicker', N'ElementUI 日期选择器', 1, 106, N'DynElementui',
...
-- ElTimePicker
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'DynElTimePicker', 1, N'表单', N'时间选择', N'⏰',
    N'{"component":"DynElTimePicker","modelname":"","options":{"comoptions":{"placeholder":"选择时间"},"labeloptions":{"label":""}}}',
    N'/ElementComponent/FormItem/TimePicker', N'ElementUI 时间选择器', 1, 107, N'DynElementui',
...
-- ElSlider
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'DynElSlider', 1, N'表单', N'滑块', N'🎚️',
    N'{"component":"DynElSlider","modelname":"","options":{"comoptions":{"min":0,"max":100},"labeloptions":{"label":""}}}',
    N'/ElementComponent/FormItem/Slider', N'ElementUI 滑块', 1, 108, N'DynElementui',
...
-- ElRate
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'DynElRate', 1, N'表单', N'评分', N'⭐',
    N'{"component":"DynElRate","modelname":"","options":{"comoptions":{"max":5},"labeloptions":{"label":""}}}',
    N'/ElementComponent/FormItem/Rate', N'ElementUI 评分', 1, 109, N'DynElementui',
...
-- ElColorPicker
MERGE dbo.ComponentMeta AS target
USING (VALUES (N'DynElColorPicker', 1, N'表单', N'颜色选择', N'🎨',
    N'{"component":"DynElColorPicker","modelname":"","options":{"comoptions":{},"labeloptions":{"label":""}}}',
    N'/ElementComponent/FormItem/ColorPicker', N'ElementUI 颜色选择器', 1, 110, N'DynElementui',
