...
namespace ScreenshotProcessApp
{
    public class FormAnnotationEditor : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // btnAddAnnotation
            //
            btnAddAnnotation.Font = new Font("微软雅黑", 9F, FontStyle.Regular, GraphicsUnit.Point);
            btnAddAnnotation.FlatStyle = FlatStyle.Flat;
            btnAddAnnotation.BackColor = Color.FromArgb(40, 167, 69);
            btnAddAnnotation.ForeColor = Color.White;
            btnAddAnnotation.Cursor = Cursors.Hand;
            btnAddAnnotation.Location = new Point(1061, 12);
            btnAddAnnotation.Name = "btnAddAnnotation";
            btnAddAnnotation.Size = new Size(85, 30);
            ...
            // btnDeleteAnnotation
            //
            btnDeleteAnnotation.Font = new Font("微软雅黑", 9F, FontStyle.Regular, GraphicsUnit.Point);
            btnDeleteAnnotation.FlatStyle = FlatStyle.Flat;
            btnDeleteAnnotation.BackColor = Color.FromArgb(220, 53, 69);
            btnDeleteAnnotation.ForeColor = Color.White;
            btnDeleteAnnotation.Cursor = Cursors.Hand;
            btnDeleteAnnotation.Location = new Point(1156, 12);
            btnDeleteAnnotation.Name = "btnDeleteAnnotation";
            btnDeleteAnnotation.Size = new Size(85, 30);
            ...
            // btnSave
            //
            btnSave.Font = new Font("微软雅黑", 9F, FontStyle.Regular, GraphicsUnit.Point);
            btnSave.FlatStyle = FlatStyle.Flat;
            btnSave.BackColor = Color.FromArgb(0, 120, 215);
            btnSave.ForeColor = Color.White;
            btnSave.Cursor = Cursors.Hand;
            btnSave.Location = new Point(1251, 12);
            ...
            btnCancel.Location = new Point(1346, 12);
            ...
            // txtAnnotationText
            //
            txtAnnotationText.Font = new Font("微软雅黑", 10F, FontStyle.Regular, GraphicsUnit.Point);
            txtAnnotationText.Location = new Point(110, 14);
            txtAnnotationText.Name = "txtAnnotationText";
            txtAnnotationText.Size = new Size(935, 28);
