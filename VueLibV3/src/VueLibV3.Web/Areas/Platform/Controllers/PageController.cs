...
public class PageController : Controller
{
    ...
    {
        ViewData["Title"] = "动作助手 Demo - VueLibV3";
        ViewData["ApiBase"] = "/api";
    ...
    {
        ViewData["Title"] = "组合组件 Demo - VueLibV3";
        ViewData["ApiBase"] = "/api";
    ...
    {
        ViewData["Title"] = "栅格布局 Demo - VueLibV3";
        ViewData["ApiBase"] = "/api";
    ...
    {
        ViewData["Title"] = "免模型 CRUD Demo - VueLibV3";
        ViewData["ApiBase"] = "/api";
    ...
    {
        ViewData["Title"] = "模板导入 Demo - VueLibV3";
        ViewData["ApiBase"] = "/api";
    ...
    {
        ViewData["Title"] = "CodeMirror Demo - VueLibV3";
        ViewData["ApiBase"] = "/api";
